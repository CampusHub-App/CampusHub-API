...
class RegistrationsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $registrations = [
            ...
            ['id' => 'k7L8', 'user_id' => '6pSlXj', 'event_id' => '6wG2yTL07N7Q', 'status' => 'registered'],
            ['id' => 'm9N0', 'user_id' => '6pSlXj', 'event_id' => 'EArzlqOiHqCy', 'status' => 'cancelled'],
            ['id' => 'o1P2', 'user_id' => '6pSlXj', 'event_id' => 'IhnQLC0AbQBt', 'status' => 'registered'],
            ['id' => 'q3R4', 'user_id' => '6pSlXj', 'event_id' => 'KudupxXgSCfO', 'status' => 'cancelled'],
            ['id' => 's5T6', 'user_id' => '6pSlXj', 'event_id' => 'mQzJaDSFaEdk', 'status' => 'registered'],
            ['id' => 'u7V8', 'user_id' => '6pSlXj', 'event_id' => 'nZLoL9zwHCHQ', 'status' => 'cancelled'],
            ['id' => 'w9X0', 'user_id' => '6pSlXj', 'event_id' => 'oRgtmFSDO6aa', 'status' => 'registered'],
            ['id' => 'y1Z2', 'user_id' => '6pSlXj', 'event_id' => 'R2FUAsX0Thil', 'status' => 'cancelled'],
            ['id' => 'a3B4', 'user_id' => '6pSlXj', 'event_id' => 'se9o9UmY3mob', 'status' => 'registered'],
